        ...
        <div className="col-12">
            <form className='form ' id='form' onSubmit={submitform}>
              ...
              <div className='' id='data'>
                <label className='form-label fs-3 ms-3'>Title :</label>
              ...
              <div className='' id='data' >
                <label className='form-label fs-3 ms-3'>Category :</label>
              ...
              <div className='' id='data'>
                <label className='form-label fs-3 ms-3'>Description :</label>
              ...
              <div id='data'>
               <label htmlFor="" className='form-label fs-3 ms-3'>file :</label>
               <input type="file"
                      onChange={handleinput}
                      name='image'
                      id='inputtext'
